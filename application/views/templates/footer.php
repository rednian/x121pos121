<a href="javascript:;" class="btn btn-icon btn-circle btn-success btn-scroll-to-top fade" data-click="scroll-top"><i class="fa fa-angle-up"></i></a>
  ...
  <!-- overlay -->
  <script src="<?php echo base_url('assets/plugins/overlay/loadingoverlay.min.js'); ?>"></script>
<!-- form validation -->
  <script src="<?php echo base_url('assets/plugins/validation/js/formValidation.min.js'); ?>"></script>
  <script src="<?php echo base_url('assets/plugins/validation/js/framework/bootstrap.min.js'); ?>"></script>
  ...
  <script src="<?php echo base_url('assets/plugins/DataTables/extensions/Buttons/js/buttons.excel.min.js'); ?>"></script>
  <script src="<?php echo base_url('assets/plugins/DataTables/extensions/Responsive/js/dataTables.responsive.min.js'); ?>"></script>
  ...
  <script src="<?php echo base_url('assets/plugins/notify/pnotify.custom.min.js'); ?>"></script>

  <script src="<?php echo base_url('assets/plugins/bootstrap-select/bootstrap-select.min.js'); ?>"></script>
  

<!--   <script src="<?php echo base_url('assets/plugins/bootstrap-daterangepickerer/js/bootstrap-datepicker.js'); ?>"></script>
 ...
 <!--  <script src="<?php echo base_url('assets/plugins/bootstrap-daterangepicker/moment.js'); ?>"></script> -->
  ...
  var service_artist_id = '';
    ...
    $(document).ready(function() {
          ...
          var table = $ ('.table-print').DataTable({
            sort:false,
           destroy:true,
              dom: 'Bfrtip',
              buttons: [
